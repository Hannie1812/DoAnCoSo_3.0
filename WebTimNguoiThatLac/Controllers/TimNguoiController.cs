...
namespace WebTimNguoiThatLac.Controllers
{
        ...
        private static readonly IEnumerable<string> TinhThanhIEnumerable = new List<string>
    {
                                                                ...
                                                                string faceDescriptorsJson)
        {
            ...
            ViewBag.DanhSachTinhThanh = new SelectList(await db.TinhThanhs.ToListAsync(), "Id", "TenTinhThanh");
            ViewBag.DanhSachQuanHuyen = new SelectList(await db.QuanHuyens.ToListAsync(), "Id", "TenQuanHuyen");
